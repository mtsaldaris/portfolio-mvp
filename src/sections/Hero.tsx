    ...
    <section id="about" className="min-h-screen flex items-center justify-center py-12 md:py-20 px-6 lg:px-12 pb-24 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 items-center relative">
        ...
        >
          ...
          {/* Stats Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 max-w-3xl mx-auto md:mx-0">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-brand-primary dark:text-brand-dark-primary" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h4a2 2 0 012 2v10a2 2 0 002 2h6a2 2 0 002-2v-4" />
                </svg>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, delay: 0.2 }}
          className="relative order-first md:order-last -mb-2 md:mb-0 col-span-2"
        >
          {/* Circular frame for portrait */}
          <div className="relative w-full max-w-[280px] md:max-w-[380px] mx-auto aspect-square">
